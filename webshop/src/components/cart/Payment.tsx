...
function Payment(props: PaymentInterface) {
	...
	const pay = () => {
		...
		const paymentBody = {
			...
			"customer_url": "https://react-webshop-e5eea.web.app",
	...
	// JSs URLi vahetada: const navigate = useNavigate() 				nagivate("/halda");
	// rakenduse väline URLi vahetus: window.location.href = "https://google.com" 
