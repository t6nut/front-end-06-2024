...
function Avaleht() {
  ...
  return (
    <div>
      ...
      <button onClick={sorteeriNimeKolmasTahtAZ}>Sorteeri nime kolmas t2ht A-Z</button>
      <br></br>
      ...
      <button onClick={filtreeriVahemalt4Tahte}>Filtreeri kellel on v2hemalt 4 t2hemarki</button>
